  ...
  <div>
    <header :class="{
      ...
      <div class="header" :style="headerW100">
        ...
        <ul class="menu menu-pc" v-if="menu">
        ...
        <ul class="menu" v-if="!menu">
          <li class="has-dropdown active menu-thumb">
            <a @click="navigateTo('/game')" :style="{ color: routerCrt == '/' ? '#7354ff' : '' }">首頁</a>
          </li>
          <li class="has-dropdown active menu-thumb">
        ...
        <div class="menu-btn">
          <!-- <div class="menu-acc">
            ...
            <a v-if="!isLogin()" @click="navigateTo('/login')" title="登入" class="menu-log menu-login">
              Login
            </a>
            <a v-if="isLogin()" title="登出" @click="signout" class="menu-log menu-logout">
              Logout
            </a>
          </div> -->
          <svg t="1746111079798" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
            p-id="2333" @click="onPopup">
            <path
        ...
        <div class="popup-menus">
          ...
          <ul class="menus" v-if="!menu">
            <li class="has-dropdown menu-thumb">
              <a @click="navigateTo('/game')" :style="{ color: routerCrt == '/' ? '#7354ff !important' : '' }">首頁</a>
            </li>
            <li class="has-dropdown menu-thumb">
              <a @click="navigateTo('/game/cointrading')" :style="{
                color:
